...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_SEL_EXTERNAL_MAIL, "SELECT id, receiver, subject, message, money, item, item_count FROM mail_command ORDER BY id ASC", CONNECTION_SYNCH);
	PrepareStatement(CHAR_DEL_EXTERNAL_MAIL, "DELETE FROM mail_command WHERE id = ?", CONNECTION_ASYNC);
